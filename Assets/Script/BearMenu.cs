...
public class BearMenu : MonoBehaviour
{
    public float speed = 0.3f; // Velocidad del enemigo
    public float distance = 2.0f; // Distancia que el enemigo recorre en cada dirección
